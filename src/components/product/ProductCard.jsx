      ...
      <div className="card-info">
        ...
        <div className="card-foot">
          ...
          <button className={`add-btn${ok?" ok":""}`} onClick={handle} aria-label={`Ajouter ${product.name}`}>
            {ok ? <><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Ajouté</> : "Ajouter"}
          </button>
        </div>
      </div>
    </article>
